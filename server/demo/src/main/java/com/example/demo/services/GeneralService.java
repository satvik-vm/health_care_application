...
public class GeneralService {
    ...
    public List<String> getStates() throws IOException {
        ...
        String relativePath = osName.equals("mac") ? "server/demo/src/main/java/com/example/demo/Json/5States_Combined.json" : "server/demo/src/main/java/com/example/demo/Json/5States_Combined.json";
...
//            String relativePath = "server/demo/src/main/java/com/example/demo/Json/5States_Combined.json";
    ...
    public List<JsonNode> getHospitals(String state, String district, String subdistrict) {
        ...
        System.setProperty("user.dir", currentDirectory + "/../Json");
        String osName = System.getProperty("os.name").toLowerCase();
        String relativePath = osName.equals("mac") ? "server/demo/src/main/java/com/example/demo/Json/Updated_hospital_data_doctors_5States.json" : "server/demo/src/main/java/com/example/demo/Json/Updated_hospital_data_doctors_5States.json";
